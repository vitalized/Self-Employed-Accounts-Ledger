  ...
  return (
    <div className="space-y-0">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card 
          className={cn(
            ...
            showTaxBreakdown && "ring-2 ring-amber-500 rounded-b-none border-b-0"
          )}
      ...
      <div className={cn(
        ...
        <Card className="rounded-t-none border-t-0 ring-2 ring-amber-500 bg-slate-50 dark:bg-slate-900">
